...
3. Copier le lien d'acces au repo sur l'icone "code". Executez la commande sur git bash "git clone " suivi du lien copié.
...
5. Dans le dossier sql, lancez le fichier gestion_projet.sql qui s'y trouve.
